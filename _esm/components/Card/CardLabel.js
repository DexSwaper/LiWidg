...
export const CardLabel = styled(Box, {
    ...
    const backgroundColor = type === 'active'
        ? theme.palette.mode === 'light'
            ? theme.palette.secondary.main
            : blend(theme.palette.background.paper, theme.palette.secondary.main, 0.8)
        : type?.includes('insurance')
            ? blend(theme.palette.background.paper, theme.palette.success.main, theme.palette.mode === 'light' ? 0.12 : 0.24)
            : theme.palette.mode === 'light'
                ? blend(theme.palette.background.paper, theme.palette.common.black, 0.12)
                : blend(theme.palette.background.paper, theme.palette.common.white, 0.16);
    return {
        backgroundColor,
