...
export const SettingsPage = () => {
    ...
    return (_jsxs(PageContainer, { bottomGutters: true, children: [_jsx(SettingsList, { children: _jsxs(SettingsCardAccordion, { children: [_jsx(ThemeSettings, {}), _jsx(LanguageSetting, {}), _jsx(RoutePrioritySettings, {}), _jsx(GasPriceSettings, {}), _jsx(SlippageSettings, {}), _jsx(BridgeAndExchangeSettings, { type: "Bridges" }), _jsx(BridgeAndExchangeSettings, { type: "Exchanges" })] }) }), _jsx(ResetSettingsButton, {})] }));
};
